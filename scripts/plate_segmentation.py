...
class PlateSegmentator:
    ...
    def split_images(self, image_list, horizontal=True, avg_mod=3, t_mod=3.3, min_len=5):
        ''' 
    ...
    def segment_plate(self, test_img):
        '''
        ...
        grey_img_list = [cv2.cvtColor(test_img, cv2.COLOR_BGR2GRAY)]
        ...
        chunks_2 = self.split_images(new_images, horizontal=True, t_mod=5, min_len=10)
        ...
        for i in range(len(plate_pairs)):
            ...
            chunks_3 = self.split_images(plate_pairs[i], horizontal=False, t_mod=2.5, avg_mod=5)
